const menuProducts = [
    // === ГРИЛЬ & BBQ ===
    { id: 1, category: "grill", title: "Стейк «Прораб»", desc: "Премиальная мраморная говядина на мощном гриле.", price: 450, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23da291c'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍖 Стейк BBQ</text></svg>" },
    { id: 2, category: "grill", title: "Ребра «Арматурные»", desc: "Свиные ребрышки тактического копчения в соусе барбекю.", price: 520, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23da291c'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍖 Ребра BBQ</text></svg>" },
    { id: 3, category: "grill", title: "Колбаски «Индустриальные»", desc: "Шашлычные колбаски со специями и дымком.", price: 410, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23da291c'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🌭 Колбаски</text></svg>" },
    { id: 4, category: "grill", title: "Шашлык «Железобетонный»", desc: "Классический сочный свиной шашлык на углях с луком.", price: 380, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23da291c'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍢 Шашлык</text></svg>" },

    // === БУРГЕРЫ ===
    { id: 5, category: "burgers", title: "Бургер «Фундаментальный»", desc: "Двойная котлета, сыр чеддер, авторский соус на черной булке.", price: 390, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23111111'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍔 Бургер</text></svg>" },
    { id: 6, category: "burgers", title: "Чикен-Лофт Бургер", desc: "Куриное филе в хрустящей панировке, майонез, салат.", price: 320, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23111111'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍔 Чикен Бургер</text></svg>" },
    { id: 7, category: "burgers", title: "Мега-Бургер «Бетон»", desc: "Огромный трехэтажный бургер для истинных строителей.", price: 590, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23111111'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍔 Мега Бургер</text></svg>" },
    { id: 8, category: "burgers", title: "Острый «Калибр»", desc: "Огненный бургер с перцем халапеньо и соусом чили.", price: 360, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23111111'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍔 Острый Бургер</text></svg>" },

    // === ПИЦЦА & ВЫПЕЧКА ===
    { id: 9, category: "pizza", title: "Пицца «Кирпич-Пепперони»", desc: "Острая колбаса пепперони, много моцареллы, томатный соус.", price: 490, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23ff9900'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍕 Пепперони</text></svg>" },
    { id: 10, category: "pizza", title: "Пицца «4 Металла»", desc: "Четыре изысканных сыра на тонком хрустящем тесте.", price: 510, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23ff9900'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍕 4 Сыра</text></svg>" },
    { id: 11, category: "pizza", title: "Пицца «Мастерок»", desc: "Домашняя пицца с ветчиной, грибами и зеленью.", price: 460, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23ff9900'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍕 Ветчина/Грибы</text></svg>" },
    { id: 12, category: "pizza", title: "Чесночный багет ДТС", desc: "Свежевыпеченный багет с ароматным чесночным маслом.", price: 140, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23ff9900'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🥖 Багет</text></svg>" },

    // === ДЕСЕРТЫ ===
    { id: 13, category: "desserts", title: "Пончик «Монтажная пена»", desc: "Нежный донат со сливочной глазурью и посыпкой.", price: 110, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23e06666'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍩 Пончик</text></svg>" },
    { id: 14, category: "desserts", title: "Торт «Шоколадный Уровень»", desc: "Многослойный шоколадный бисквит с насыщенным крем-чизом.", price: 210, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23e06666'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍰 Шоко Торт</text></svg>" },
    { id: 15, category: "desserts", title: "Чизкейк «Шпаклевка»", desc: "Классический нью-йоркский нежный творожный десерт.", price: 190, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23e06666'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍰 Чизкейк</text></svg>" },
    { id: 16, category: "desserts", title: "Вафли «Опалубка»", desc: "Бельгийские рифленые вафли с карамельным топпингом.", price: 160, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23e06666'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🧇 Вафли</text></svg>" },

    // === НАПИТКИ ===
    { id: 17, category: "drinks", title: "Лимонад «Энергетик ДТС»", desc: "Бодрящий газированный цитрусовый микс.", price: 150, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%233cc157'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🥤 Лимонад</text></svg>" },
    { id: 18, category: "drinks", title: "Холодный Кофе «Сварщик»", desc: "Тонизирующий айс-латте с карамельным сиропом.", price: 180, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%233cc157'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>☕ Айс Кофе</text></svg>" },
    { id: 19, category: "drinks", title: "Крафтовый Квас ДТС", desc: "Натуральный резвый квас на ржаном хлебе.", price: 120, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%233cc157'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍺 Квас ДТС</text></svg>" },
    { id: 20, category: "drinks", title: "Горячий Чай «Анкер»", desc: "Крепкий черный листовой чай с бергамотом и лимоном.", price: 90, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%233cc157'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍵 Чай Анкер</text></svg>" },
    
    // === ДОПОЛНИТЕЛЬНОЕ НАПОЛНЕНИЕ ===
    { id: 21, category: "street", title: "Лапша WOK «Сварка»", desc: "Острая пшеничная лапша с овощами и курицей.", price: 350, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23ff9900'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍜 Лапша WOK</text></svg>" },
    { id: 22, category: "pizza", title: "Мини-пицца «Детская»", desc: "Сырная пицца небольшого диаметра с сосисками.", price: 250, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23ff9900'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🍕 Мини-Пицца</text></svg>" },
    { id: 23, category: "desserts", title: "Круассан Французский", desc: "Слоеная воздушная выпечка с начинкой из сгущенки.", price: 130, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23e06666'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🥐 Круассан</text></svg>" },
    { id: 24, category: "grill", title: "Овощи на гриле ДТС", desc: "Болгарский перец, баклажаны и томаты с соусом песто.", price: 290, img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300' viewBox='0 0 400 300'><rect width='100%' height='100%' fill='%23da291c'/><text x='50%' y='50%' font-family='sans-serif' font-size='24' font-weight='bold' fill='white' dominant-baseline='middle' text-anchor='middle'>🥗 Овощи Гриль</text></svg>" }
];
